...
import { getTransactionAction } from "../../redux/slice/transactions/transactionSlice";
...
const TransactionList = ({ transactions }) => {
  ...
  /* const { transaction, error, loading } = useSelector((state) => state?.transactions);
              ...
              <tbody>
                ...
                {transactions.map((transaction) => (
                  <tr className="h-18 border-b border-coolGray-100">
                    ...
                    <Link
                      to={`/edit-transaction/${transactions._id}`}
